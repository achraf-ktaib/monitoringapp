...
<template>
	<div>
		...
		<a-card :bordered="false" class="header-solid h-full mb-24" :bodyStyle="{paddingTop: '14px'}">
			<template #title>
				<h6 class="font-semibold">Projets Énergétiques</h6>			
				<p>Surveillance de la consommation énergétique</p>	
			</template>
	...
	const projects = [
		{
			...
			content: "Suivi de la consommation énergétique des installations.",
		...
		},
		{
			...
			content: "Analyse des coûts énergétiques pour une meilleure efficacité.",
		...
		},
		{
			...
			content: "Projets d'intégration des énergies renouvelables.",
